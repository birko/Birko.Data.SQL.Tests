...
{
    /// <summary>
    /// Concrete DbParameterCollection stub for testing. Required because
    /// DbParameterCollection members are non-virtual in .NET 10+ and cannot be mocked.
    /// </summary>
    public class TestDbParameterCollection : DbParameterCollection
    {
        ...
        /// <summary>
        /// Get all parameters as a typed list for test assertions.
        /// </summary>
        public IReadOnlyList<DbParameter> All => _parameters.AsReadOnly();
    }
}
